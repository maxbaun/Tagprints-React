export default {
	apiBase: API_URL, // eslint-disable-line no-undef
	...
	mailchimpRegion: MAILCHIMP_REGION, // eslint-disable-line no-undef
	mailchimpList: MAILCHIMP_LIST // eslint-disable-line no-undef
};
